...
-->		+0000 00 class BSTEventSink<struct BSThreadEvent::ThreadEvent> | 0125BB5C
		...
		+0004 02 struct BSTSingletonSDMBase<struct BSTSDMTraits<class HavokSystem::`anonymous namespace'::HavokThreadMemorySink,struct BSTSingletonSDMOpStaticBuffer<class HavokSystem::`anonymous
namespace'::HavokThreadMemorySink> > > | 0125BD90 +0004 00 struct BSTSDMTraits<class HavokSystem::`anonymous namespace'::HavokThreadMemorySink,struct BSTSingletonSDMOpStaticBuffer<class
HavokSystem::`anonymous namespace'::HavokThreadMemorySink> > | 0125BE50 +0005 00 struct BSTSingletonSDMOpStaticBuffer<class HavokSystem::`anonymous namespace'::HavokThreadMemorySink> | 0125BEF8
		*/
	};
};
