...
class BSScriptObject
{
	...
	DEFINE_MEMBER_FN(ctor, BSScriptObject*, 0x00C30DF0, const BSScriptClassPtr& classPtr, SkyrimScript::HandlePolicy* policy,
					 UInt32 numProperties); // called from 00C48AE1(IObjectManagerInterface::CreateScriptObject), 00C495CD
