...
class BSScriptClass : public BSIntrusiveRefCounted
{
	...
	{
		return (IFunction**)(dataPtr + sizeof(FlagData) * numScriptFlags + sizeof(VariableData) * numVariables + sizeof(DefaultValueData) * numDefaultValues + sizeof(PropertyData) * numProperties);
	}
	...
	{
		return (DefaultValueData*)(dataPtr + sizeof(FlagData) * numScriptFlags + sizeof(VariableData) * numVariables);
	}

	PropertyData* GetProperties() const
	{
		return (PropertyData*)(dataPtr + sizeof(FlagData) * numScriptFlags + sizeof(VariableData) * numVariables + sizeof(DefaultValueData) * numDefaultValues);
	}
