...
template<class>
struct typeid_builtin
{
};
template<>
struct typeid_builtin<void> : typeid_None
{
};
template<>
struct typeid_builtin<SInt32> : typeid_Int
{
};
template<>
struct typeid_builtin<UInt32> : typeid_Int
{
};
template<>
struct typeid_builtin<float> : typeid_Float
{
};
template<>
struct typeid_builtin<bool> : typeid_Bool
{
};
template<>
struct typeid_builtin<const char*> : typeid_String
{
};
template<>
struct typeid_builtin<BSFixedString> : typeid_String
{
};
template<>
struct typeid_builtin<const BSFixedString&> : typeid_String
{
};
...
/// is_builtin
template<class>
struct is_builtin : std::false_type
{
};
template<>
struct is_builtin<void> : std::true_type
{
};
template<>
struct is_builtin<SInt32> : std::true_type
{
};
template<>
struct is_builtin<UInt32> : std::true_type
{
};
template<>
struct is_builtin<float> : std::true_type
{
};
template<>
struct is_builtin<bool> : std::true_type
{
};
template<>
struct is_builtin<const char*> : std::true_type
{
};
template<>
struct is_builtin<BSFixedString> : std::true_type
{
};
template<>
struct is_builtin<const BSFixedString&> : std::true_type
{
};
...
/// is_packable
template<class _Ty>
struct is_packable : std::integral_constant<bool, !std::is_same<_Ty, StaticFunctionTag*>::value && !std::is_void<_Ty>::value &&
													  (is_builtin<_Ty>::value || is_form_pointer<_Ty>::value ||
													   (is_array<_Ty>::value && (is_builtin<typename remove_array<_Ty>::type>::value || is_form_pointer<typename remove_array<_Ty>::type>::value)))>
{
};
