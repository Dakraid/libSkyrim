...
class TESForm : public BaseFormComponent
{
	...
	virtual const char* GetAliasName(const BSFixedString& alias); // 2E 00450A50 - alias: "Pronoun" "PronounObj" "PronounPos" "PronounPosObj" "PronounRef" "PronounInt" "Race" "Gender" "ShortName". see
	...
	bool IsNot(FormType type) const
	{
		return formType != type;
	}
	template<class First, class... Rest>
