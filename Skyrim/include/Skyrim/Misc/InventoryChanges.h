...
class InventoryChanges
{
	...
	class IItemChangeVisitor
	{
		...
		virtual bool   Unk_02(UInt32 arg1, UInt32 arg2)
		{ // 00780780
			return true;
		}
		virtual UInt32 Unk_03(InventoryEntryData* pEntry, UInt32 arg2, bool& result)
		{ // 00474C30
			result = true;
			return Visit(pEntry);
		}
	...
	DEFINE_MEMBER_FN(RemoveItem, const RefHandle&, 0x0047E920, UInt32 arg1, TESObjectREFR* owner, TESForm* akItem, UInt32 aiCount, UInt32 mode, BaseExtraList* extraList, TESObjectREFR* moveToRef,
					 UInt32 unk8, UInt32 unk9);
...
class ItemFilter
{
	...
	virtual bool Visit(InventoryEntryData* pEntry)
	{ // 00C8CCA0
		return true;
	}
};
...
class QuestItemFilter : public ItemFilter
{
	...
	virtual bool Visit(InventoryEntryData* pEntry) override
	{ // 00476A50
