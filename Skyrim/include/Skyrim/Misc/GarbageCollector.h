...
==============================================================================*/
class GarbageCollector : public BSTSingletonSDM<GarbageCollector>, public BSTEventSink<PositionPlayerEvent>
{
	public:
	...
	inline void Add(NiAVObject* pObj)
	{
		AddNiAVObject(pObj);
	}
	inline void Add(TESBoundObject* pObj)
	{
		AddTESBoundObject(pObj);
	}
	inline void Add(BSAnimationGraphManager* pObj)
	{
		AddAnimationGraphManager(pObj);
	}
	inline void ClearTempEffects()
	{
		ClearTempEffects_Impl();
	}
