...
class Unknown012E32E8
{
	...
	//
	BSTArray<RefHandle>
						actorsHigh; // 028 // ref handles for Actors in high process. the TDETECT command loops over this to delete AI/detection state in actors. general AI processing loops over this as well.
