...
class ActorState : public IMovementState
{
	...
	UInt32 GetSitState() const
	{
		...
		switch(state) {
			case 1:
			case 2: return kSitState_WantsToSit;
			case 3: return kSitState_Sitting;
			case 4: return kSitState_WantsToStand;
			default: return kSitState_NotSitting;
		}
	}
	...
	UInt32 GetSleepState() const
	{
		...
		switch(state) {
			case 5:
			case 6: return kSleepState_WantsToSleep;
			case 7: return kSleepState_Sleeping;
			case 8: return kSleepState_WantsToWake;
			default: return kSleepState_NotSleeping;
		}
	}
