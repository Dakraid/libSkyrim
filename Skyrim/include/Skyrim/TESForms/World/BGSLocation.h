					...
					public BGSKeywordForm // 1C
{
	...
	enum
	{
		kTypeID = (UInt32)FormType::Location
	};
	...
	{ // 008EA080 - Location.IsLoaded()
		return (unk6C) ? true : false;
	}
	bool IsCleared(void) const
	{ // 008EA070 - Location.IsCleared()
		return isCleard;
	}
	bool IsChild(BGSLocation* akOther) const
	{ // 008E9FC0 - Location.IsChild()
		bool result = false;
	...
	float GetKeywordData(const BGSKeyword* keyword) const
	{ // 008EA040 - Location.GetKeywordData(Keyword)
