...
0008: |   |   class BSTHashMapBase<struct BSTHashMapTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTDefaultScatterTable<unsigned int,class
BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *> > > 0008: |   |   |   struct BSTHashMapTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const
*,struct BSTDefaultScatterTable<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *> > 000C: |   |   |   struct BSTDefaultScatterTable<unsigned int,class
BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *> 000C: |   |   |   |   class BSTScatterTable<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const
*,struct BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy,struct BSTScatterTableHeapAllocator,8> 000C: |   |   |   |   |   class BSTScatterTableBase<struct
...
000C: |   |   |   |   |   |   class BSTScatterTableKernel<struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct
...
SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> > 000C: |   |   |   |   |   |   |   struct BSTScatterTableTraits<unsigned int,class BSTArray<struct
SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct
BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> 000D: |   |   |   |   |   |   |   struct
BSTScatterTableDefaultHashPolicy<unsigned int> 0021: |   |   |   |   |   |   struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class
BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> > 0000: |   class NiRefObject
==============================================================================*/
// 28
class AttackAnimationArrayMap : public BSTHashMap<UInt32, BSTArray<SetEventData> const*>, // 04
