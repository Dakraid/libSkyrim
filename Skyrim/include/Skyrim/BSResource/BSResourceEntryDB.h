...
0418: |   |   struct BSTSingletonSDMBase<struct BSTSDMTraits<class BSResource::EntryDB<struct LipSynchAnimDB::DBTraits>,struct BSTSingletonSDMOpStaticBuffer<class BSResource::EntryDB<struct
LipSynchAnimDB::DBTraits> > > > 0418: |   |   |   struct BSTSDMTraits<class BSResource::EntryDB<struct LipSynchAnimDB::DBTraits>,struct BSTSingletonSDMOpStaticBuffer<class BSResource::EntryDB<struct
LipSynchAnimDB::DBTraits> > > 0419: |   |   |   struct BSTSingletonSDMOpStaticBuffer<class BSResource::EntryDB<struct LipSynchAnimDB::DBTraits> >
==============================================================================*/
template<class Traits>
class EntryDB : public IEntryDB,											// 00
...
struct EntryDBBase : public Traits,						  // 00
