...
typedef BSRenderTargetGroup* (*_CreateRenderTargetGroup)(BSFixedString* linkName, UInt32 width, UInt32 height, NiTexture::FormatPrefs* format, UInt32 unk1, UInt8 unk2, UInt32 unk3, UInt32 unk4,
														 UInt32 unk5, UInt32 unk6, UInt32 unk7);
