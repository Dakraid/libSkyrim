...
/*==============================================================================
0000: class BSTScatterTableKernel<struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct
BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const
*,struct BSTScatterTableDefaultKVStorage> >,8> > 0000: |   struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct
BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct
SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> 0001: |   struct BSTScatterTableDefaultHashPolicy<unsigned int>
==============================================================================*/
// 15
							  ...
							  protected Traits::hash_policy // 01
{
	...
	bool _insert(entry_type* entries, hash_type hash, const key_type& key, const value_type& value, UInt16& unk)
	{
		...
		// bucket overlap
		while(p->next != targetEntry) p = p->next;
	...
	bool _erase(entry_type* entries, hash_type hash, const key_type& key)
	{
		...
		entry_type* targetEntry = _entry_at(entries, hash);
		if(targetEntry->empty()) { return false; }
		...
		while(true) {
			if(curEntry == m_eolPtr) return false;		// not found
			if(is_key_equal(curEntry->key, key)) break; // found
...
/*==============================================================================
0000: class BSTScatterTableBase<struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct
BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const
*,struct BSTScatterTableDefaultKVStorage> >,8> > 0000: |   class BSTScatterTableKernel<struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const
*,struct BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct
SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> > 0000: |   |   struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class
BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned
int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> 0001: |   |   struct BSTScatterTableDefaultHashPolicy<unsigned int> 0015: |
	...
	class const_iterator
	{
		...
		const_iterator(const BSTScatterTableBase* a_table, entry_type* a_entry) : m_table(a_table), m_entry(a_entry)
		{
			if(a_entry) {
				...
				while(m_entry < tail && m_entry->empty()) { m_entry += 1; }
			} else {
...
/*==============================================================================
0000: class BSTScatterTable<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy,struct
BSTScatterTableHeapAllocator,8> 0000: |   class BSTScatterTableBase<struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct
BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct
SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> > 0000: |   |   class BSTScatterTableKernel<struct BSTScatterTableTraits<unsigned int,class
BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy<unsigned int>,struct
BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> > 0000: |   |
|   struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct
BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const
*,struct BSTScatterTableDefaultKVStorage> >,8> 0001: |   |   |   struct BSTScatterTableDefaultHashPolicy<unsigned int> 0015: |   |   struct BSTScatterTableHeapAllocator<struct
BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >
==============================================================================*/
template<class Key, class Value, template<class, class> class Storage, template<class> class Policy, template<class> class Allocator, std::size_t INITIAL_TABLE_SIZE>
class BSTScatterTable : public BSTScatterTableBase<BSTScatterTableTraits<Key, Value, Storage, Policy<Key>, Allocator<BSTScatterTableEntry<Key, Value, Storage>>, INITIAL_TABLE_SIZE>>
{
	...
	bool insert(const key_type& key, const value_type& lvalue)
	{
		...
		while(!(p = _insert(m_entries, hash, key))) {
			_grow_table();
			if(!m_entries || !m_freeCount) return false;
		}
	...
	{
		hash_type hash = get_hash(key);
		while(!insert_original(m_entries, hash, key, value, unk)) { _grow_table(); }
		return true;
	}
...
0000: |   class BSTScatterTable<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct
BSTScatterTableDefaultHashPolicy,struct BSTScatterTableHeapAllocator,8> 0000: |   |   class BSTScatterTableBase<struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class
BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned
int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> > 0000: |   |   |   class BSTScatterTableKernel<struct
BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct BSTScatterTableDefaultHashPolicy<unsigned
int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >,8> >
0000: |   |   |   |   struct BSTScatterTableTraits<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage,struct
BSTScatterTableDefaultHashPolicy<unsigned int>,struct BSTScatterTableHeapAllocator<struct BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const
*,struct BSTScatterTableDefaultKVStorage> >,8> 0001: |   |   |   |   struct BSTScatterTableDefaultHashPolicy<unsigned int> 0015: |   |   |   struct BSTScatterTableHeapAllocator<struct
BSTScatterTableEntry<unsigned int,class BSTArray<struct SetEventData,class BSTArrayHeapAllocator> const *,struct BSTScatterTableDefaultKVStorage> >
==============================================================================*/
