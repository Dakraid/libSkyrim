...
bool TESForm::HasKeyword(BGSKeyword* keyword) const // 008FCCA0
{
	...
	switch(this->formType) {
		case FormType::EffectSetting: keywordForm = cast_to_keywordform<EffectSetting>(this); break;
		case FormType::NPC: keywordForm = cast_to_keywordform<TESActorBase>(this); break;
		case FormType::Race: keywordForm = cast_to_keywordform<TESRace>(this); break;
		case FormType::Armor: keywordForm = cast_to_keywordform<TESObjectARMO>(this); break;
		case FormType::Weapon: keywordForm = cast_to_keywordform<TESObjectWEAP>(this); break;
		case FormType::Location: keywordForm = cast_to_keywordform<BGSLocation>(this); break;
		case FormType::Activator:
		case FormType::TalkingActivator:
		case FormType::Flora:
		case FormType::Furniture: keywordForm = cast_to_keywordform<TESObjectACTI>(this); break;
		case FormType::Enchantment:
		case FormType::Spell:
		case FormType::ScrollItem:
		case FormType::Ingredient:
		case FormType::Potion: keywordForm = cast_to_keywordform<MagicItem>(this); break;
		case FormType::Misc:
		case FormType::Apparatus:
		case FormType::Key:
		case FormType::SoulGem: keywordForm = cast_to_keywordform<TESObjectMISC>(this); break;
		case FormType::Ammo: keywordForm = cast_to_keywordform<TESAmmo>(this); break;
		case FormType::Book: keywordForm = cast_to_keywordform<TESObjectBOOK>(this); break;
		default: keywordForm = DYNAMIC_CAST<BGSKeywordForm*>(const_cast<TESForm*>(this)); break;
	}
	if(keywordForm) { return keywordForm->HasKeyword(keyword); }

	TESObjectREFR* ref = const_cast<TESForm*>(this)->GetReference();
	if(ref) { return ref->HasKeyword(keyword); }
