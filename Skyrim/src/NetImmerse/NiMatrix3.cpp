...
const NiMatrix3 NiMatrix3::ZERO(NiPoint3(0.0f, 0.0f, 0.0f), NiPoint3(0.0f, 0.0f, 0.0f), NiPoint3(0.0f, 0.0f, 0.0f));

const NiMatrix3 NiMatrix3::IDENTITY(NiPoint3(1.0f, 0.0f, 0.0f), NiPoint3(0.0f, 1.0f, 0.0f), NiPoint3(0.0f, 0.0f, 1.0f));

static inline void sincos(float radians, float& sin, float& cos)
{
	float s, c;

	__asm fld radians __asm fsincos __asm fstp c __asm fstp s
...
{
	return (m_entry[0][0] == mat.m_entry[0][0]) && (m_entry[0][1] == mat.m_entry[0][1]) && (m_entry[0][2] == mat.m_entry[0][2]) && (m_entry[1][0] == mat.m_entry[1][0]) &&
		   (m_entry[1][1] == mat.m_entry[1][1]) && (m_entry[1][2] == mat.m_entry[1][2]) && (m_entry[2][0] == mat.m_entry[2][0]) && (m_entry[2][1] == mat.m_entry[2][1]) &&
...
{
	NiMatrix3 tmp;
	tmp.m_entry[0][0] = m_entry[0][0] * rhs.m_entry[0][0] + m_entry[0][1] * rhs.m_entry[1][0] + m_entry[0][2] * rhs.m_entry[2][0];

	tmp.m_entry[1][0] = m_entry[1][0] * rhs.m_entry[0][0] + m_entry[1][1] * rhs.m_entry[1][0] + m_entry[1][2] * rhs.m_entry[2][0];

	tmp.m_entry[2][0] = m_entry[2][0] * rhs.m_entry[0][0] + m_entry[2][1] * rhs.m_entry[1][0] + m_entry[2][2] * rhs.m_entry[2][0];

	tmp.m_entry[0][1] = m_entry[0][0] * rhs.m_entry[0][1] + m_entry[0][1] * rhs.m_entry[1][1] + m_entry[0][2] * rhs.m_entry[2][1];

	tmp.m_entry[1][1] = m_entry[1][0] * rhs.m_entry[0][1] + m_entry[1][1] * rhs.m_entry[1][1] + m_entry[1][2] * rhs.m_entry[2][1];

	tmp.m_entry[2][1] = m_entry[2][0] * rhs.m_entry[0][1] + m_entry[2][1] * rhs.m_entry[1][1] + m_entry[2][2] * rhs.m_entry[2][1];

	tmp.m_entry[0][2] = m_entry[0][0] * rhs.m_entry[0][2] + m_entry[0][1] * rhs.m_entry[1][2] + m_entry[0][2] * rhs.m_entry[2][2];

	tmp.m_entry[1][2] = m_entry[1][0] * rhs.m_entry[0][2] + m_entry[1][1] * rhs.m_entry[1][2] + m_entry[1][2] * rhs.m_entry[2][2];

	tmp.m_entry[2][2] = m_entry[2][0] * rhs.m_entry[0][2] + m_entry[2][1] * rhs.m_entry[1][2] + m_entry[2][2] * rhs.m_entry[2][2];
...
{
	return NiPoint3(m_entry[0][0] * pt.x + m_entry[0][1] * pt.y + m_entry[0][2] * pt.z, m_entry[1][0] * pt.x + m_entry[1][1] * pt.y + m_entry[1][2] * pt.z,
...
static float NiFastATan2(float y, float x)
{
	...
	if(std::fabs(y) > std::fabs(x)) {
		...
		if(z == 0.0f) return (x > 0.0f) ? 0.0f : NI_PI;
	}
	...
	if(offset) result = offset - result;

	if(y < 0.0f && x < 0.0f) result -= NI_PI;
	if(y > 0.0f && x < 0.0f) result += NI_PI;
...
bool NiMatrix3::ToEulerAnglesXZY(float& rfXAngle, float& rfZAngle, float& rfYAngle) const
{
...
bool NiMatrix3::ToEulerAnglesYXZ(float& rfYAngle, float& rfXAngle, float& rfZAngle) const
{
...
bool NiMatrix3::ToEulerAnglesYZX(float& rfYAngle, float& rfZAngle, float& rfXAngle) const
{
...
bool NiMatrix3::ToEulerAnglesZXY(float& rfZAngle, float& rfXAngle, float& rfYAngle) const
{
...
bool NiMatrix3::ToEulerAnglesZYX(float& rfZAngle, float& rfYAngle, float& rfXAngle) const
{
