...
static UInt32 skses[] = {MAKE_SKYRIM_VERSION(1, 3, 0),	MAKE_SKYRIM_VERSION(1, 4, 0),
						 MAKE_SKYRIM_VERSION(1, 4, 1),	MAKE_SKYRIM_VERSION(1, 4, 2),
						 MAKE_SKYRIM_VERSION(1, 4, 3),	MAKE_SKYRIM_VERSION(1, 4, 4),
						 MAKE_SKYRIM_VERSION(1, 4, 5),	MAKE_SKYRIM_VERSION(1, 4, 6),
						 MAKE_SKYRIM_VERSION(1, 4, 7),	MAKE_SKYRIM_VERSION(1, 4, 8),
						 MAKE_SKYRIM_VERSION(1, 4, 9),	MAKE_SKYRIM_VERSION(1, 4, 10),
						 MAKE_SKYRIM_VERSION(1, 4, 11), MAKE_SKYRIM_VERSION(1, 4, 12),
						 MAKE_SKYRIM_VERSION(1, 4, 13), MAKE_SKYRIM_VERSION(1, 4, 14),
						 MAKE_SKYRIM_VERSION(1, 4, 15), MAKE_SKYRIM_VERSION(1, 5, 1),
						 MAKE_SKYRIM_VERSION(1, 5, 2),	MAKE_SKYRIM_VERSION(1, 5, 3),
						 MAKE_SKYRIM_VERSION(1, 5, 4),	MAKE_SKYRIM_VERSION(1, 5, 5),
						 MAKE_SKYRIM_VERSION(1, 5, 6),	MAKE_SKYRIM_VERSION(1, 5, 7),
						 MAKE_SKYRIM_VERSION(1, 5, 8),	MAKE_SKYRIM_VERSION(1, 5, 9),
						 MAKE_SKYRIM_VERSION(1, 5, 10), MAKE_SKYRIM_VERSION(1, 5, 11),
						 MAKE_SKYRIM_VERSION(1, 6, 0),	MAKE_SKYRIM_VERSION(1, 6, 1),
						 MAKE_SKYRIM_VERSION(1, 6, 2),	MAKE_SKYRIM_VERSION(1, 6, 3),
						 MAKE_SKYRIM_VERSION(1, 6, 4),	MAKE_SKYRIM_VERSION(1, 6, 5),
						 MAKE_SKYRIM_VERSION(1, 6, 6),	MAKE_SKYRIM_VERSION(1, 6, 7),
						 MAKE_SKYRIM_VERSION(1, 6, 8),	MAKE_SKYRIM_VERSION(1, 6, 9),
						 MAKE_SKYRIM_VERSION(1, 6, 10), MAKE_SKYRIM_VERSION(1, 6, 11),
						 MAKE_SKYRIM_VERSION(1, 6, 12), MAKE_SKYRIM_VERSION(1, 6, 13),
						 MAKE_SKYRIM_VERSION(1, 6, 14), MAKE_SKYRIM_VERSION(1, 6, 15),
						 MAKE_SKYRIM_VERSION(1, 6, 16), 0};
...
template<>
SKSEInterface::Version SKSEPlugin::GetInterfaceVersion<SKSEInterface>() const
{
	return (SKSEInterface::Version)skseVersion;
}
template<>
SKSEScaleformInterface::Version SKSEPlugin::GetInterfaceVersion<SKSEScaleformInterface>() const
{
	return (SKSEScaleformInterface::Version)(scaleform ? scaleform->version : 0);
}
template<>
SKSEPapyrusInterface::Version SKSEPlugin::GetInterfaceVersion<SKSEPapyrusInterface>() const
{
	return (SKSEPapyrusInterface::Version)(papyrus ? papyrus->version : 0);
}
template<>
SKSESerializationInterface::Version SKSEPlugin::GetInterfaceVersion<SKSESerializationInterface>() const
{
	return (SKSESerializationInterface::Version)(serialization ? serialization->version : 0);
}
template<>
SKSETaskInterface::Version SKSEPlugin::GetInterfaceVersion<SKSETaskInterface>() const
{
	return (SKSETaskInterface::Version)(task ? task->version : 0);
}
template<>
SKSEMessagingInterface::Version SKSEPlugin::GetInterfaceVersion<SKSEMessagingInterface>() const
{
...
SKSE_API bool SKSEPlugin_Query(const SKSEInterface* a_skse, PluginInfo* info)
{
	...
	if(!thePlugin->InitInstance()) { return false; }
...
{
	if(!thePlugin->OnLoad()) { return false; }
