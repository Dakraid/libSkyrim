...
/*==============================================================================
class `public: static bool __cdecl Script::ResetDialogueFlags(struct SCRIPT_PARAMETER const *,char const *,class TESObjectREFR *,class TESObjectREFR *,class Script *,class ScriptLocals *,double
&,unsigned int &)'::`2'::MobDialogueFlagResetter +0000 (_vtbl=0109518C) 0000: class `public: static bool __cdecl Script::ResetDialogueFlags(struct SCRIPT_PARAMETER const *,char const *,class
TESObjectREFR *,class TESObjectREFR *,class Script *,class ScriptLocals *,double &,unsigned int &)'::`2'::MobDialogueFlagResetter 0000: |   class MobIterOperator
==============================================================================*/
...
#pragma pack(pop)
	...
	static bool Cmd_Default_Execute(const SCRIPT_PARAMETER* paramInfo, const char* scriptData, TESObjectREFR* thisObj, TESObjectREFR* containingObj, Script* scriptObj, ScriptLocals* locals,
